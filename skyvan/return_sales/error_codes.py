...
class ReturnSaleOrderErrorCode(Enum):
    ...
    INVALID_SUPPLIER = "invalid_customer"  # Customer does not exist or is not valid
    ...
    RETURN_SALE_ORDER_UPDATE_FAILED = "return_sale_order_update_failed"
    RETURN_SALE_LINE_CREATION_FAILED = "return_sale_line_creation_failed"
    RETURN_SALE_ORDER_CREATION_FAILED = "return_sale_order_creation_failed"