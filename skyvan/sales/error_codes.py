...
class SaleOrderErrorCode(Enum):
    ...
    SALE_ORDER_CREATION_FAILED = "sale_order_creation_failed"
    SALE_LINE_CREATION_FAILED = "sale_line_creation_failed"
    SALE_ORDER_UPDATE_FAILED = "sale_order_update_failed"
